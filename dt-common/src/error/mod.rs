...
pub use external_adapter::{
    classify_mongodb_error, classify_redis_error, dt_error_from_mongodb, dt_error_from_redis,
    ExternalErrorClassification,
};
pub use report::{DiagnosticReport, ErrorReport};
pub use sqlx_adapter::{
    classify_sqlx_error, dt_error_from_sqlx, try_dt_error_from_anyhow_sqlx,
