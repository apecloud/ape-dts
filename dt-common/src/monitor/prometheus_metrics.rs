...
impl PrometheusMetrics {
    ...
    pub fn initialization(&self) -> &Self {
        ...
        register_handler(
            "checker_generate_sql_count",
            "the total revise sql count generated by checker",
        ...
        register_handler(
            "checker_generate_sql_rps_min",
            "the min revise sql per second of checker",
            TaskMetricsType::CheckerGenerateSqlRpsMin,
        );
        register_handler(
            "checker_generate_sql_rps_max",
            "the max revise sql per second of checker",
            TaskMetricsType::CheckerGenerateSqlRpsMax,
        );
        register_handler(
            "checker_generate_sql_rps_avg",
            "the average revise sql per second of checker",
