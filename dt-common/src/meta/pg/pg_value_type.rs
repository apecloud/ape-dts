...
pub(super) const BYTEA_OID: i32 = 17;
pub(super) const CHAR_OID: i32 = 18;
pub(super) const NAME_OID: i32 = 19;
pub(super) const INT8_OID: i32 = 20;
pub(super) const INT2_OID: i32 = 21;
pub(super) const INT4_OID: i32 = 23;
pub(super) const TEXT_OID: i32 = 25;
pub(super) const OID_OID: i32 = 26;
...
pub(super) const CIDR_OID: i32 = 650;
// const CIDR_ARRAY_OID: i32 = 651;
pub(super) const FLOAT4_OID: i32 = 700;
pub(super) const FLOAT8_OID: i32 = 701;
// const CIRCLE_OID: i32 = 718;
// const CIRCLE_ARRAY_OID: i32 = 719;
// const UNKNOWN_OID: i32 = 705;
pub(super) const MACADDR8_OID: i32 = 774;
pub(super) const MONEY_OID: i32 = 790;
pub(super) const MACADDR_OID: i32 = 829;
pub(super) const INET_OID: i32 = 869;
...
pub(super) const DATE_OID: i32 = 1082;
pub(super) const TIME_OID: i32 = 1083;
pub(super) const TIMESTAMP_OID: i32 = 1114;
const TIMESTAMP_ARRAY_OID: i32 = 1115;
const DATE_ARRAY_OID: i32 = 1182;
// const TIME_ARRAY_OID: i32 = 1183;
pub(super) const TIMESTAMPTZ_OID: i32 = 1184;
const TIMESTAMPTZ_ARRAY_OID: i32 = 1185;
pub(super) const INTERVAL_OID: i32 = 1186;
// const INTERVAL_ARRAY_OID: i32 = 1187;
// const NUMERIC_ARRAY_OID: i32 = 1231;
pub(super) const TIMETZ_OID: i32 = 1266;
// const TIMETZ_ARRAY_OID: i32 = 1270;
pub(super) const BIT_OID: i32 = 1560;
// const BIT_ARRAY_OID: i32 = 1561;
pub(super) const VARBIT_OID: i32 = 1562;
// const VARBIT_ARRAY_OID: i32 = 1563;
pub(super) const NUMERIC_OID: i32 = 1700;
// const RECORD_OID: i32 = 2249;
// const RECORD_ARRAY_OID: i32 = 2287;
pub(super) const UUID_OID: i32 = 2950;
