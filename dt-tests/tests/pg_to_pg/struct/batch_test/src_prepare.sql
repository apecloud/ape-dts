...
CREATE INDEX index_index ON struct_it_pg2pg_2.full_index_type (index_col);

CREATE INDEX fulltext_index ON struct_it_pg2pg_2.full_index_type USING gin(fulltext_col);

CREATE INDEX spatial_index ON struct_it_pg2pg_2.full_index_type USING gist(spatial_col);
...
COMMENT ON TABLE struct_it_pg2pg_2.full_index_type IS 'Comment on full_index_type.';

-- column comments:
COMMENT ON COLUMN struct_it_pg2pg_2.full_column_type.id IS 'Comment on full_column_type.id.';
COMMENT ON COLUMN struct_it_pg2pg_2.full_index_type.id IS 'Comment on full_index_type.id.';

-- sequences

-- case 1: sequeces created automatically when creating table
CREATE TABLE struct_it_pg2pg_2.sequence_test_1 (seq_1 SERIAL, seq_2 BIGSERIAL, seq_3 SMALLSERIAL);

-- case 2: create independent sequences, then alter their owners
CREATE SEQUENCE struct_it_pg2pg_2.sequence_test_2_seq_1;
CREATE SEQUENCE struct_it_pg2pg_2.sequence_test_2_seq_2;
CREATE SEQUENCE struct_it_pg2pg_2.sequence_test_2_seq_3;

CREATE TABLE struct_it_pg2pg_2.sequence_test_2 (seq_1 INTEGER, seq_2 BIGINT, seq_3 SMALLINT);

-- in postgres, sequence must be in same schema as table it is linked to
-- actually, postgres allows mutiple sequences owned by the same table.column, here we just ignore
ALTER SEQUENCE struct_it_pg2pg_2.sequence_test_2_seq_1 OWNED BY struct_it_pg2pg_2.sequence_test_2.seq_1;
ALTER SEQUENCE struct_it_pg2pg_2.sequence_test_2_seq_2 OWNED BY struct_it_pg2pg_2.sequence_test_2.seq_2;
ALTER SEQUENCE struct_it_pg2pg_2.sequence_test_2_seq_3 OWNED BY struct_it_pg2pg_2.sequence_test_2.seq_3;
...
-- case 4: create independent sequences and never used by any tables
-- we should not migrate them
CREATE SEQUENCE struct_it_pg2pg_2.sequence_test_4_seq_1;
...
CREATE INDEX index_index ON struct_it_pg2pg_3.full_index_type (index_col);

CREATE INDEX fulltext_index ON struct_it_pg2pg_3.full_index_type USING gin(fulltext_col);

CREATE INDEX spatial_index ON struct_it_pg2pg_3.full_index_type USING gist(spatial_col);
...
COMMENT ON TABLE struct_it_pg2pg_3.full_index_type IS 'Comment on full_index_type.';

-- column comments:
COMMENT ON COLUMN struct_it_pg2pg_3.full_column_type.id IS 'Comment on full_column_type.id.';
COMMENT ON COLUMN struct_it_pg2pg_3.full_index_type.id IS 'Comment on full_index_type.id.';

-- sequences

-- case 1: sequeces created automatically when creating table
CREATE TABLE struct_it_pg2pg_3.sequence_test_1 (seq_1 SERIAL, seq_2 BIGSERIAL, seq_3 SMALLSERIAL);

-- case 2: create independent sequences, then alter their owners
CREATE SEQUENCE struct_it_pg2pg_3.sequence_test_2_seq_1;
CREATE SEQUENCE struct_it_pg2pg_3.sequence_test_2_seq_2;
CREATE SEQUENCE struct_it_pg2pg_3.sequence_test_2_seq_3;

CREATE TABLE struct_it_pg2pg_3.sequence_test_2 (seq_1 INTEGER, seq_2 BIGINT, seq_3 SMALLINT);

-- in postgres, sequence must be in same schema as table it is linked to
-- actually, postgres allows mutiple sequences owned by the same table.column, here we just ignore
ALTER SEQUENCE struct_it_pg2pg_3.sequence_test_2_seq_1 OWNED BY struct_it_pg2pg_3.sequence_test_2.seq_1;
ALTER SEQUENCE struct_it_pg2pg_3.sequence_test_2_seq_2 OWNED BY struct_it_pg2pg_3.sequence_test_2.seq_2;
ALTER SEQUENCE struct_it_pg2pg_3.sequence_test_2_seq_3 OWNED BY struct_it_pg2pg_3.sequence_test_2.seq_3;
...
-- case 4: create independent sequences and never used by any tables
-- we should not migrate them
CREATE SEQUENCE struct_it_pg2pg_3.sequence_test_4_seq_1;
