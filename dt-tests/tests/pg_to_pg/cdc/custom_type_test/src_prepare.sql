...
-- REPLICA IDENTITY FULL for CDC to capture old row values on UPDATE/DELETE
ALTER TABLE test_db_1.user_orders REPLICA IDENTITY FULL;
ALTER TABLE test_db_1.task_list REPLICA IDENTITY FULL;
ALTER TABLE test_db_1.composite_type_table REPLICA IDENTITY FULL;
ALTER TABLE test_db_1.custom_range_table REPLICA IDENTITY FULL;
ALTER TABLE test_db_1.domain_type_table REPLICA IDENTITY FULL;
ALTER TABLE test_db_1.special_type_name_table REPLICA IDENTITY FULL;
