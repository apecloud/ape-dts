...
CREATE TABLE struct_it_mysql2mysql_1.full_column_type_with_default (
    ...
    timestamp_precision_col4 TIMESTAMP(6) DEFAULT CURRENT_TIMESTAMP(6),
    timestamp_precision_col5 TIMESTAMP(6) DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6) COMMENT 'timestamp_precision_col5_comment',
