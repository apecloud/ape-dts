...
CREATE TABLE `full_column_type_with_default` (
  ...
  `timestamp_precision_col4` timestamp(6) NULL DEFAULT CURRENT_TIMESTAMP(6),
  `timestamp_precision_col5` timestamp(6) NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6) COMMENT 'timestamp_precision_col5_comment',
...
CREATE TABLE `match` (
  ...
  `table` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `column` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL
  `offset` int NOT NULL,
  `unique_col` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
