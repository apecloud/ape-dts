...
CREATE TABLE IF NOT EXISTS struct_check_test_1.not_match_index (
  ...
  PRIMARY KEY (`id`),
  KEY `i5_diff_name_src` (`index_col`),
  UNIQUE KEY `u_index` (`unique_col`),
  FULLTEXT KEY `f_index` (`fulltext_col`),
  KEY `i4_diff_order` (`composite_index_col2`,`composite_index_col1`,`composite_index_col3`),
  KEY `i6_miss` (`index_col`)
