...
CREATE NONCLUSTERED INDEX idx_filter_2
    ON struct_filter_mssql2mssql_2.full_index_type (index_col DESC);
GO
...
EXEC sys.sp_addextendedproperty
    @name = N'MS_Description', @value = N'not migrated by constraint-index filter',
    @level0type = N'SCHEMA', @level0name = N'struct_filter_mssql2mssql_2',
