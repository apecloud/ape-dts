...
INSERT INTO key_structure.single_primary_rows VALUES
...
INSERT INTO key_structure.primary_and_unique_rows VALUES
...
INSERT INTO key_structure.composite_unique_rows VALUES
    (1, N'us-east', -2147483648, N'min'),
    (2, N'us-east', 0, N'zero'),
    (3, N'us-east', 2147483647, N'max'),
    (4, N'中国', 1, N'中文'),
    (5, N'', 1, NULL);
INSERT INTO key_structure.nullable_composite_unique_rows VALUES
    (1, 1, N'a', N'complete'),
...
INSERT INTO key_structure.all_primary_rows VALUES
    (-2147483648, N'', 0x00),
    (0, N'a', 0x0001),
    (0, N'a', 0x0002),
    (1, N'中文', 0xE4BDA0E5A5BD),
