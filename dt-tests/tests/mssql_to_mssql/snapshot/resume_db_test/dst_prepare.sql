USE [ape_dts];
GO
IF DB_ID(N'ape_dts_resume_test') IS NULL CREATE DATABASE [ape_dts_resume_test];
GO
...
DROP TABLE IF EXISTS [ape_dts_resume_test].[dbo].[positions];
...
INSERT INTO [ape_dts].resume_test.resume_rows VALUES (1, N'one'), (2, N'two'), (3, N'three');
INSERT INTO [ape_dts].resume_test.composite_rows VALUES (1, 1, N'one-one'), (1, 2, N'one-two');
INSERT INTO [ape_dts].resume_test.binary_key_rows VALUES (0x00FF, N'binary-one'), (0x0102, N'binary-two');
INSERT INTO [ape_dts].resume_test.[resume table.*] VALUES (1, N'special-one');
INSERT INTO [ape_dts].resume_test.string_key_rows VALUES (N'a', 0x01), (N'b', 0x02);

CREATE TABLE [ape_dts_resume_test].[dbo].[positions] (
...
INSERT INTO [ape_dts_resume_test].[dbo].[positions]
    (task_id, resumer_type, position_key, position_data) VALUES
    (N'mssql_resume_db_test', N'SnapshotDoing', N'ape_dts-resume_test-resume_rows',
     N'{"type":"RdbSnapshot","db_type":"mssql","db":"ape_dts","schema":"resume_test","tb":"resume_rows","order_key":{"single":["id","3"]}}'),
    (N'mssql_resume_db_test', N'SnapshotDoing', N'ape_dts-resume_test-composite_rows',
     N'{"type":"RdbSnapshot","db_type":"mssql","db":"ape_dts","schema":"resume_test","tb":"composite_rows","order_key":{"composite":[["tenant_id","1"],["row_id","2"]]}}'),
    (N'mssql_resume_db_test', N'SnapshotDoing', N'ape_dts-resume_test-binary_key_rows',
     N'{"type":"RdbSnapshot","db_type":"mssql","db":"ape_dts","schema":"resume_test","tb":"binary_key_rows","order_key":{"single":["binary_id","0102"]}}'),
    (N'mssql_resume_db_test', N'SnapshotDoing', N'ape_dts-resume_test-resume table.*',
     N'{"type":"RdbSnapshot","db_type":"mssql","db":"ape_dts","schema":"resume_test","tb":"resume table.*","order_key":{"single":["p.k","1"]}}'),
    (N'mssql_resume_db_test', N'SnapshotDoing', N'ape_dts-resume_test-string_key_rows',
     N'{"type":"RdbSnapshot","db_type":"mssql","db":"ape_dts","schema":"resume_test","tb":"string_key_rows","order_key":{"single":["code","b"]}}'),
    (N'mssql_resume_db_test', N'SnapshotFinished', N'ape_dts-resume_test-finished_rows', NULL),
    (N'mssql_resume_db_test', N'SnapshotFinished', N'ape_dts-resume_test-finished_rows_2', NULL);
GO
