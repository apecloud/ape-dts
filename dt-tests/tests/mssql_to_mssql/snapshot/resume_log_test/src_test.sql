...
INSERT INTO [ape_dts].resume_log_test.[resume table.*] VALUES
    (1, N'special-one'), (2, N'special-two'), (3, N'special-three');
INSERT INTO [ape_dts].resume_log_test.nullable_composite_unique_rows VALUES
    (1, 1, N'a', N'one-a'), (2, 1, N'b', N'one-b'),
    (3, NULL, N'a', N'null-a'), (4, NULL, N'a', N'null-a-duplicate'),
    (5, 2, NULL, N'two-null'), (6, NULL, NULL, NULL);
INSERT INTO [ape_dts].resume_log_test.string_key_rows VALUES
...
INSERT INTO [ape_dts].resume_log_test.no_key_rows VALUES
    (1, N'one'), (NULL, N'null-key'), (2, NULL), (1, N'one');
INSERT INTO [ape_dts].resume_log_test.fresh_rows VALUES
    (-2147483648, N'fresh-min'), (0, N''), (2147483647, NULL);
INSERT INTO [ape_dts].resume_log_test.finished_config_rows VALUES
    (1, N'skipped-config'), (2, N'skipped-config-two');
INSERT INTO [ape_dts].resume_log_test.finished_log_rows VALUES
