...
DROP TABLE IF EXISTS route_dst_schema.schema_payloads;
DROP TABLE IF EXISTS route_table_dst.target_orders;
DROP TABLE IF EXISTS route_table_dst.target_metrics;
DROP TABLE IF EXISTS route_col_dst.target_users;
DROP TABLE IF EXISTS route_col_dst.target_events;
...
CREATE TABLE route_dst_schema.schema_payloads (
...
CREATE TABLE route_table_dst.target_metrics (
...
CREATE TABLE route_col_dst.target_events (
