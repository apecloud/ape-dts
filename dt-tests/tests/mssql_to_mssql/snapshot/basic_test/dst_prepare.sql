...
CREATE TABLE [ape_dts].basic_test.tbl_2 (code varchar(21) NULL, name nvarchar(30) NOT NULL);
...
CREATE TABLE [ape_dts].basic_test.tbl_5 (code varchar(21) NULL, name nvarchar(30) NULL);
