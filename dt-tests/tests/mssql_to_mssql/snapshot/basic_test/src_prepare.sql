...
CREATE TABLE [ape_dts].basic_test.no_pk_no_uk (
    ...
    binary_value varbinary(32) NULL,
...
CREATE TABLE [ape_dts].basic_test.string_binary_table (
    ...
    max_text_value nvarchar(max) NULL,
    binary_value binary(8) NULL,
    varbinary_value varbinary(max) NULL,
    xml_value xml NULL,
...
CREATE TABLE [ape_dts].basic_test.[col has special character] (
    ...
    [col.3] nvarchar(100) NULL,
    [col with space] nvarchar(100) NULL,
...
CREATE TABLE [ape_dts].basic_test.multi_primary_and_single_unique_table (
    ...
    uk2 nvarchar(10) NOT NULL UNIQUE,
    value int NULL,
    PRIMARY KEY (pk1, pk2)
);
