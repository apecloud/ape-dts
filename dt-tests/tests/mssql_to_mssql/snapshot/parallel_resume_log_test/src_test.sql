...
INSERT INTO [ape_dts].parallel_resume_log.no_key_rows VALUES
    (1, N'one'), (1, N'one-duplicate-key'), (2, N'two'), (3, NULL),
    (4, N'中文'), (5, N''), (6, N'six'), (7, N'seven');
INSERT INTO [ape_dts].parallel_resume_log.unique_rows VALUES
...
INSERT INTO [ape_dts].parallel_resume_log.finished_rows VALUES
    (1, N'skipped-one'), (2, N'skipped-two');
INSERT INTO [ape_dts].parallel_resume_log.finished_config_rows VALUES
