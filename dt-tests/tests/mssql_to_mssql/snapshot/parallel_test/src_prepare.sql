...
CREATE TABLE [ape_dts].parallel_test.integer_rows (
    id int NOT NULL PRIMARY KEY,
    value int NULL
);
CREATE TABLE [ape_dts].parallel_test.integer_more_rows (
    id int NOT NULL PRIMARY KEY,
    value int NULL
);
CREATE TABLE [ape_dts].parallel_test.string_rows (
    id nvarchar(255) NOT NULL PRIMARY KEY,
    value int NULL
);
CREATE TABLE [ape_dts].parallel_test.no_key_rows (
    id int NOT NULL,
    value int NULL
);
...
CREATE TABLE [ape_dts].parallel_test.unique_rows (
    row_id int NOT NULL,
    id int NULL UNIQUE,
    value int NULL
);
CREATE TABLE [ape_dts].parallel_test.all_null_rows (
    id int NULL,
    value int NULL
);
CREATE TABLE [ape_dts].parallel_test.where_condition_1 (
    id int NOT NULL PRIMARY KEY,
    value int NOT NULL
);
CREATE TABLE [ape_dts].parallel_test.where_condition_2 (
    id int NOT NULL PRIMARY KEY,
    value int NOT NULL
);
CREATE TABLE [ape_dts].parallel_test.fallback_no_key_rows (
    id int NOT NULL,
    value int NULL
);
CREATE TABLE [ape_dts].parallel_test.fallback_primary_rows (
    id int NOT NULL PRIMARY KEY,
    value int NULL
);
CREATE TABLE [ape_dts].parallel_test.bigint_rows (
...
CREATE TABLE [ape_dts].parallel_test.date_rows (
