...
CREATE TABLE table_parallel_test.integer_rows (id int NOT NULL PRIMARY KEY, value int NULL);
CREATE TABLE table_parallel_test.integer_more_rows (id int NOT NULL PRIMARY KEY, value int NULL);
CREATE TABLE table_parallel_test.string_rows (id nvarchar(255) NOT NULL PRIMARY KEY, value int NULL);
CREATE TABLE table_parallel_test.no_key_rows (id int NOT NULL, value int NULL);
CREATE TABLE table_parallel_test.nullable_partition_rows (
    row_id int NOT NULL PRIMARY KEY, id int NULL, value int NULL
);
CREATE TABLE table_parallel_test.unique_rows (row_id int NOT NULL, id int NULL UNIQUE, value int NULL);
CREATE TABLE table_parallel_test.all_null_rows (id int NULL, value int NULL);
CREATE TABLE table_parallel_test.where_condition_1 (id int NOT NULL PRIMARY KEY, value int NOT NULL);
CREATE TABLE table_parallel_test.where_condition_2 (id int NOT NULL PRIMARY KEY, value int NOT NULL);
CREATE TABLE table_parallel_test.fallback_no_key_rows (id int NOT NULL, value int NULL);
CREATE TABLE table_parallel_test.fallback_primary_rows (id int NOT NULL PRIMARY KEY, value int NULL);
CREATE TABLE table_parallel_test.bigint_rows (id bigint NOT NULL PRIMARY KEY, value nvarchar(30) NULL);
CREATE TABLE table_parallel_test.decimal_rows (
    id decimal(20, 4) NOT NULL PRIMARY KEY, value nvarchar(30) NULL
);
CREATE TABLE table_parallel_test.date_rows (id date NOT NULL PRIMARY KEY, value nvarchar(30) NULL);
