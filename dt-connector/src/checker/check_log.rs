...
impl StructCheckKey {
    ...
    pub fn with_location(&self, schema: &str, tb: &str) -> Self {
        Self::new(self.key.with_location(schema, tb))
    }
...
mod tests {
    ...
    fn checker_logs_keep_expected_json_shape() {
        ...
        let key = StructCheckKey::new(StructKey::new(StructKeyType::Index, ["s1", "t1", "idx_1"]));
        ...
        let target_key =
            StructCheckKey::new(StructKey::new(StructKeyType::Index, ["s2", "t2", "idx_1"]));
        ...
        let column_privilege = StructCheckKey::new(StructKey::new(
        ...
        let special_identifier = StructCheckKey::new(StructKey::new(
            StructKeyType::Index,
            ["a.b", "t.1", "idx.1"],
        ));
